...
2) Установка Ruby
 ...
 //Установка ssh ключа для того чтобы не вводить каждый раз логин пароль

 - cd ~/.ssh //Заходим в директорию с ключами
 ...
 - git remote show //Посмотреть список удаленных репозиториев

 - git remote rm origin //Удалить удаленный репозиторий с названием origin
 ...
 - heroku open //Открывает залитый проект
